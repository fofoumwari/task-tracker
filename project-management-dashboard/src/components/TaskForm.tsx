...
export const TaskForm: React.FC<TaskFormProps> = ({ editingTask, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-transparent backdrop-blur flex items-center justify-center p-4 z-50">
      <div className="bg-white border-gray-600 rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto ">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 pt-4">
            <button
              ...
              className="flex-1 bg-green-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors"
            >
